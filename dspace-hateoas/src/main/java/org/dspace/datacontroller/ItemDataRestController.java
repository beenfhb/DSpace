package org.dspace.datacontroller;
...
@RestController
@RequestMapping("/api/complex/item")
public class ItemDataRestController {
	
	private final ItemRepository itemRepository;
	private final CollectionRepository collectionRepository;
	
	@Autowired
	public ItemDataRestController(ItemRepository itemRepository, CollectionRepository collectionRepository) {
