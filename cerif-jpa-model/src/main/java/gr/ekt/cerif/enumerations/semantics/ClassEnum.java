...
public enum ClassEnum {
	...
	BOOK_SERIES("5886019b-1b77-41f9-9cd1-e58db68ef238	Book Series","Book Series"),
	...
	SCPNUMBER("1da7f6dd-519f-4b87-a0b0-6699d5adae83","Scopus publication identifier"),
	ISSN("117a8179-1779-494b-9fb3-4f8bb806ebce","issn"),
	ISBN("c424da87-2d94-471a-977a-2412b7eb89fd","isbn"),
	OPENACCESS_TYPES("24b6f4f4-8161-4e6a-8af4-444f038deae8","Open Access Types"),
	LICENSE_TYPES("704845f1-6b38-4130-be96-e65e3b9ef80d", "License Types"),
	CC_ZERO("5c4d7157-da8c-44e2-a9c8-565fb281eac7","CC Zero (CC0)"),
	CC_ATTRIBUTION("c164cfcb-bfb1-4d64-8441-ca15da24fbbf","CC Attribution (CC BY)"),
	CC_ATTRIBUTION_NONCOMMERCIAL("e0c7250c-4c2a-4ae9-9a87-86cd19d696f3","CC Attribution-NonCommercial (CC BY-NC)"),
	CC_ATTRIBUTION_NONCOMMERCIAL_NODERIVS("87dcdd26-41a7-4135-b2c6-d8b1a1bcc310","CC Attribution-NonCommercial-NoDerivs (CC BY-NC-ND)"),
	CC_ATTRIBUTION_NONCOMMERCIAL_SHAREALIKE("b668edc8-8ae0-4d55-830a-58b3c0916be5","CC Attribution-NonCommercial-ShareAlike (CC BY-NC-SA)"),
	CC_ATTRIBUTION_NODERIVS("5f7ca0c7-2bac-4322-af72-5740dfb91838","CC Attribution-NoDerivs (CC BY-ND)"),
	CC_ATTRIBUTION_SHAREALIKE("bf14644d-deed-4271-bd26-602a29c75243","CC Attribution-ShareAlike (CC BY-SA)"),
	EUPL("606cf596-cc1e-4763-a5fc-400938677853","European Union Public Licence (EUPL)"),
	GFDL("c943e37a-9827-421e-8eda-538a83b69ff2","GNU Free Documentation License (GFDL)"),
	GPL("10fde5b6-9add-4e51-b1db-f1b46c23ede6","GNU General Public License (GPL)"),
	LGPL("fce5cde8-5580-495f-b036-1670ddc71fae","GNU Lesser General Public License (LGPL)"),
	ODC_PDDL("91f872ec-e853-452f-8095-05ca089799a5","ODC Public Domain Dedication and License (ODC PDDL)"),
	ODC_BY("76c33ed7-be3f-4952-8988-519592ee3428","ODC Attribution (ODC BY)"),
	ODC_ODBL("5d06e413-c510-40ad-a574-d956e6e35cca","ODC Open Database License (ODC ODbL)"),
	CLOSED_ACCESS("12a82377-3da5-475d-af64-416683975afd","Closed Access"),
	EMBARGOED_ACCESS("c03204d4-daa0-4daf-b24c-cecfafe66f62","Embargoed Access"),
	OPEN_ACCESS("134ce02e-89da-424a-906d-8a260a744776","Open Access"),
	RESTRICTED_ACCESS("4a13052a-0a63-499c-9d1f-bb4c29d9c6a6","Restricted Access"),
	LANG("685b398c-6246-4aab-9507-7f533e4085ae","Language"),
